...
[Open the dashboard](index.html) to compare six OPM employment snapshots from September 2022 through July 2026. Choose an agency and, where available, an OPM agency subelement. Compare employee counts, selected occupational series, and combinations of education levels.
