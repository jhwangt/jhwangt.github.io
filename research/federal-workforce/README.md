...
An interactive, exploratory view of federal employment and reported AI use cases. [Open the dashboard](index.html) after GitHub Pages is enabled.

## What you can explore

- Federal workforce counts by agency and, where available, component or bureau
- CFO Act agencies and departments as a combined scope or individually
...
- **Snapshot:** The dashboard was generated from the research project in June 2026. It is not a live feed.
...
- `PUBLISHING.md`: steps to create a GitHub repository and enable Pages
